...
from vllm_ascend.torchair.utils import TorchairCommonAttentionMetadata, TORCHAIR_CACHE_DIR
...
class EagleTorchairProposer(EagleProposer):
    ...
    def propose(
        ...
        # )
        is_running_torchair = not self.runner.with_prefill
    ...
    def dummy_run(self,
        ...
        is_running_torchair = not with_prefill
    ...
    def generate_token_ids(self,
        ...
        if spec_decode_metadata is None:
            ...
            accepted_token_indices = token_indices
